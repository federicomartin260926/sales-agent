    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $aiCostSeeds = [
            ...
            [
                ...
                'output' => 1.20,
                'currency' => 'USD',
                'notes' => 'Modelo económico para cargas de alto volumen.',
                'active' => true,
            ],
            [
                'usageType' => AiModelCostReference::USAGE_TYPE_LLM_CHAT,
                ...
                'output' => 12.00,
                'currency' => 'USD',
                'notes' => 'Modelo equilibrado para agentes conversacionales y uso de tools.',
                'active' => true,
            ],
            [
                'usageType' => AiModelCostReference::USAGE_TYPE_LLM_CHAT,
                ...
                'output' => 20.00,
                'currency' => 'USD',
                'notes' => 'Modelo de máxima capacidad para tareas complejas.',
                'active' => true,
            ],
            [
