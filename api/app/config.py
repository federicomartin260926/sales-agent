...
class Settings(BaseSettings):
    ...
    openai_responses_max_attempts: int = Field(default=4, alias="OPENAI_RESPONSES_MAX_ATTEMPTS")
    openai_responses_retry_delay_seconds: float = Field(default=5.0, alias="OPENAI_RESPONSES_RETRY_DELAY_SECONDS")
