...
class Settings(BaseSettings):
    ...
    openai_responses_max_attempts: int = Field(default=2, alias="OPENAI_RESPONSES_MAX_ATTEMPTS")
    openai_responses_retry_delay_seconds: float = Field(default=0.5, alias="OPENAI_RESPONSES_RETRY_DELAY_SECONDS")
    ...
    new_llm_orchestration_slot_selection_enabled: bool = Field(
        default=False,
        alias="NEW_LLM_ORCHESTRATION_SLOT_SELECTION_ENABLED",
    )
